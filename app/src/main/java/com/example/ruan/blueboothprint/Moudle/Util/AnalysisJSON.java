...
//    }
    ...
    public static ArrayList<ContentValues> Release_Information(String msg) {
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                ContentValues contentValues = new ContentValues();
                contentValues.put("articleId" , json.getString("articleId"));
                contentValues.put("articleContent", json.getString("articleContent"));
                contentValues.put("articleImages", json.getString("articleImages"));
                contentValues.put("articleRelease", json.getString("articleRelease"));
                contentValues.put("articleTime", json.getString("articleTime"));
                contentValues.put("articleType", json.getString("articleType"));
                contentValues.put("articleUrl", json.getString("articleUrl"));
                contentValues.put("userId", json.getString("userId"));
                contentValues.put("userNickname", json.getString("userNickname"));
