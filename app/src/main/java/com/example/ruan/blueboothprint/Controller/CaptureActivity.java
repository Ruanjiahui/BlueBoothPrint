...
import com.example.ruan.blueboothprint.boothprint.camera.CameraManager;
import com.example.ruan.blueboothprint.boothprint.decoding.CaptureActivityHandler;
import com.example.ruan.blueboothprint.boothprint.decoding.InactivityTimer;
import com.example.ruan.blueboothprint.boothprint.view.ViewfinderView;
...
//    private Button cancelScanButton;
    ...
    public void inti() {
        ...
        view = LayoutInflater.from(context).inflate(R.layout.camera , null);
...
//        });
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (resultString.equals("")) {
            ...
            Qcode.list.add(AdapterData.getMap(resultString, DensityUtil.dip2px(this, 50)));
